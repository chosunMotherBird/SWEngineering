...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String url="http://192.168.5.5:8088/chargers/all";
        NetworkTask networkTask=new NetworkTask(url,null);
        networkTask.execute();

        LatLng Chosun_IT = new LatLng(35.139807, 126.934066);
        mMap.moveCamera(CameraUpdateFactory.newLatLng(Chosun_IT));
    ...
    public class SearchChargerDetail extends Thread {
        ...
        @Override
        public void run() {
            this.result = new RequestHttpConnection().request("http://192.168.5.5:8088/chargers/" + id, null);
        }
